...
제 8조 (서비스의 변경 및 중단)
① 회사는 서비스(개별서비스 포함)를 변경하여야 하는 상당한 이유가 있는 경우 변경될 서비스의 내용을 회원에게 이메일 또는 홈페이지에 공지하고 변경할 수 있습니다
...
제 9조 (정보 제공 및 광고 게재)
①회사는 서비스를 운영함에 있어 각종 정보를 서비스 화면에 게재하거나 메일, 쪽지, SMS등의 방법으로 회원에게 제공할 수 있습니다.
②회사는 서비스의 운영과 관련하여 광고 등을 서비스 화면에 게재하거나, 메일, 쪽지, SMS등을 통하여 발송할 수 있습니다. 다만, 회사는 회원에게 메일, 쪽지, SMS 등의 발송을 하는 경우 수신 동의 여부를 확인하여, 수신 동의한 회원에 한하여 이를 발송합니다.
...
① 회사는 회원이 서비스에 게시하거나 전달하는 게시물이 다음 각호에 해당된다고 판단되는 경우 사전 통지 없이 해당 게시물에 대한 임시조치, 삭제 또는 게시 거부 등 필요한 조치를 할 수 있습니다. 다만, 회사가 모든 게시물을 검토할 의무를 가지는 것은 아닙니다. 수령자가 불건전하거나 불법적인 내용으로 신고할 경우에 검토합니다.
...
- 회사의 서비스를 홍보하기 위한 목적으로 미디어, 통신사 등에 게시물 등의 전부 또는 일부를 보도, 방영하게 하는 것. 다만, 이 경우 회사는 회원의 개별 동의없이 미디어, 통신사 등에게 회원정보를 제공하지 않습니다.
제 12조 (회사의 의무)
...
제 14조 (회원에 대한 통지)
① 회사는 회원의 서비스 이용에 필요한 권리 및 의무 등에 관한 사항을 회사가 발급한 또는 회원이 지정한 메일, SMS 등으로 통지할 수 있습니다.
